...
<head>
    ...
    <link rel="stylesheet" href="informasisidang(up).css">
</head>
...
<body>
        ...
        <div class="overlap-group">
            <div class="overlap-group3">
                ...
                <div class="frame10">
                    <h5>Aksi</h5>
                    <div class="frame20">
                        <div class="pilihstatus">Pilih Status:</div>
                        <div class="container">
                            <select name="" id="">
                                <option value="">Selection Option</option>
                                <option value="">opsi1</option>
    ...
    <script src="informasi(up)dropbtn.js"></script>
</body>
